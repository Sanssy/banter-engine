...
func TestCalculateAndDetectPointImpacts(t *testing.T) {
	...
	current := []forecasts.Forecast{
		{UserID: "user-1", UserName: "Alice", MatchID: "match-1", Points: 7},
		{UserID: "user-2", UserName: "Bob", MatchID: "match-1", Points: 0},
		{UserID: "user-3", UserName: "Charlie", MatchID: "match-1", Points: 3},
	}
	wantImpacts := []pointImpact{
		{UserID: "user-1", UserName: "Alice", MatchID: "match-1", PreviousPoints: 0, CurrentPoints: 7, Delta: 7},
		{UserID: "user-2", UserName: "Bob", MatchID: "match-1", PreviousPoints: 5, CurrentPoints: 0, Delta: -5},
		{UserID: "user-3", UserName: "Charlie", MatchID: "match-1", PreviousPoints: 1, CurrentPoints: 3, Delta: 2},
	}
